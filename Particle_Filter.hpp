...
struct Particle {
  ...
  class Particle_Filter {
    ...
    public:
      ...
      Particle_Filter(double x_pos0, double x_vel0,
      ...
      // Full update of the filter with a cluster measurement
      void updateFilterWeights(const ds_av_msgs::DataspeedObject& meas);
    ...
    double stdv[4] = {0.1, 0.1, 0.2, 0.2};
    double stdv_meas[2] = {0.1, 0.1};
